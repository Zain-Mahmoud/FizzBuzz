...
- [z] Extract a method from `Multiples.main` that will return
...
and run the tests in it to check your work — debugging as needeUse git to push your updated `Multiples.java` file to GitHub and run the self tests again on MarkUs.
